"""Create filling and production tables v2

Revision ID: create_filling_production_tables_v2
...
revision = 'create_filling_production_tables_v2'
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('kilo_per_size', sa.Float(), nullable=True, server_default='0.0'),
        sa.Column('requirement_kg', sa.Float(), nullable=True, server_default='0.0'),
    ...
    op.create_table(
        ...
        sa.Column('batches', sa.Float(), nullable=True, server_default='0.0'),
        sa.Column('total_kg', sa.Float(), nullable=True, server_default='0.0'),
        sa.Column('requirement_kg', sa.Float(), nullable=True, server_default='0.0'),
