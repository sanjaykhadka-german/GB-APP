...
class FinishedGoods(db.Model):
    ...
    packaging_material_1_id = db.Column(db.Integer, db.ForeignKey('raw_material.id'))
    packaging_material_2_id = db.Column(db.Integer, db.ForeignKey('raw_material.id'))
    offset_in_days = db.Column(db.Integer, nullable=True)
    label_type_id = db.Column(db.Integer, db.ForeignKey('raw_material.id'))
    box_label_type_id = db.Column(db.Integer, db.ForeignKey('raw_material.id'))
    ...
    inner_box_type_id = db.Column(db.Integer, db.ForeignKey('raw_material.id'))
    pack_per_inner = db.Column(db.Integer, nullable=True)
    box_type_id = db.Column(db.Integer, db.ForeignKey('raw_material.id'))
    ...
    casing_used_id = db.Column(db.Integer, db.ForeignKey('raw_material.id'))
    clip_used_id = db.Column(db.Integer, db.ForeignKey('raw_material.id'))
    ...
    # Relationships
    packaging_material_1 = db.relationship('RawMaterial', foreign_keys=[packaging_material_1_id])
    packaging_material_2 = db.relationship('RawMaterial', foreign_keys=[packaging_material_2_id])
    label_type = db.relationship('RawMaterial', foreign_keys=[label_type_id])
    box_label_type = db.relationship('RawMaterial', foreign_keys=[box_label_type_id])
    inner_box_type = db.relationship('RawMaterial', foreign_keys=[inner_box_type_id])
    box_type = db.relationship('RawMaterial', foreign_keys=[box_type_id])
    casing_used = db.relationship('RawMaterial', foreign_keys=[casing_used_id])
    clip_used = db.relationship('RawMaterial', foreign_keys=[clip_used_id])
